...
{
    pc.Value.inputBuffer.Enqueue(num++);
}
...
class StateMachine
{
    ...
    public Queue<long> inputBuffer { get; set; } = new Queue<long>(10000000);
    public Queue<long> outputBuffer { get; set; } = new Queue<long>(10000000);
    public long i { get; set; }
    public long relativeBase { get; set; }
    //public List<StateMachine> others { get; set; }
    ...
    public int Execute()
    {
        ...
        //Console.WriteLine($"{Key} {opCode} {i} {inputBuffer.Count} {outputBuffer.Count}");
